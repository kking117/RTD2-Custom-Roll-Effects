...
{
	name = "RTD2 Sticky Mouse",
	author = "kking117",
	description = "Adds the negative perk Sticky Mouse to rtd2."
};
...
void RegisterPerk()
{
    RTD2_ObtainPerk("stickymouse") // create perk using unique token "mytoken"
        .SetName("Sticky Mouse") // set perk's name
        .SetGood(false) // make the perk good
		.SetTime(0)
        .SetSound("vo/sniper_sf13_magic_reac01.mp3") // set activation sound
        ...
        .SetTags("bad, mouse, sticky, mvm_bot") // set perk's search tags
