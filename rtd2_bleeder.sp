...
public Plugin myinfo = 
{
	name = "RTD2 Bleeder",
	author = "kking117",
	description = "Adds the positive perk Bleeder to rtd2."
};

public void OnPluginStart()
{
	cvarBDmgMult=CreateConVar("rtd_bleeder_dmg_mult", "2.0", "Bleeder's damage multiplier.", _, true, 0.0, false, 9999.0);
...
void RegisterPerk()
{
    RTD2_ObtainPerk("bleeder") // create perk using unique token "mytoken"
        .SetName("Bleeder") // set perk's name
        .SetGood(true) // make the perk good
		.SetTime(0)
        .SetSound("vo/taunts/soldier_taunts10.mp3") // set activation sound
        ...
        .SetTags("good, bleed, bleeding, dot, damage, mvm_bot") // set perk's search tags
